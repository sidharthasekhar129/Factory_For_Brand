...
public class Home_sale extends RecyclerView.Adapter<Home_sale.Programmingviewholder> {
    ...
    public Home_sale(String[] data1, String[] data2, String[] data3, String[] path111, String[] path222){
        this.data1=data1;
        this.data2=data2;
        this.data3=data3;
        this.path1=path111;
    ...
    public Programmingviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view= inflater.inflate(R.layout.home_scroll_3,parent,false);
    ...
    public class Programmingviewholder extends RecyclerView.ViewHolder {
        ...
        public Programmingviewholder(@NonNull View itemView) {
            super(itemView);
            imgicon=(ImageView) itemView.findViewById(R.id.pic111);
            txttitle2=(TextView)itemView.findViewById(R.id.name111);

            txttitle3=(TextView)itemView.findViewById(R.id.name222);


            linearLayout=(LinearLayout)itemView.findViewById(R.id.linear3);
